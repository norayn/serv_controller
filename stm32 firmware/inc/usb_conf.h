...
// $USBCONFIG -- задать число ендпойнтов
//#define EP_NUM                          (3)
#define EP_NUM                          (2)
...
// $USBCONFIG -- задать адреса буфера всем ендпойнтам с учетом
...
// $USBCONFIG -- закомментировать дефайны Callback-ов используемых ендпойнтов
