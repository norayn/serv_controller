...
def LogStatus():
    ...
    LogFile.write( "\n" )
    LogFile.write( "cpu term = " + str( PrevServerState.RawCpuTerm ) + "C \n" )
    LogFile.write( "free memory= " + str( PrevServerState.RawFreeMemory ) + " of " + str( PrevServerState.RawAllMemory ) + " Mb \n" )
    LogFile.write( "Hdd Torrent free space persent= %.2f" % PrevServerState.RawHddTorrentFreePersent + " \n" )
    LogFile.write( "Hdd    Raid free space persent= %.2f" % PrevServerState.RawHddRaidFreePersent + " \n" )
    LogFile.write( "Hdd  System free space persent= %.2f" % PrevServerState.RawHddSystemFreePersent + " \n" )
    LogFile.close()
